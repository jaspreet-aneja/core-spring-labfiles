...
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
		...
		Restaurant restaurent = restaurantRepository.findByMerchantNumber(dining.getMerchantNumber());
		MonetaryAmount monetaryAmount = restaurent.calculateBenefitFor(account, dining);
